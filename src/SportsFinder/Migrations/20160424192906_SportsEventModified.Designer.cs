...
namespace SportsFinder.Migrations
{
    ...
    [Migration("20160424192906_SportsEventModified")]
    partial class SportsEventModified
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SportsFinder.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("SportsFinder.Models.Equipment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SportsFinder.Models.Sport", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SportsFinder.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SportsFinder.Models.Equipment", b =>
                {
                    b.HasOne("SportsFinder.Models.Sport")
                        .WithMany()
